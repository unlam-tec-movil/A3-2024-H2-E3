...
sealed class CaptureUserPhotoExceptions : Throwable() {
    data class UnknownError(override val message: String) : CaptureUserPhotoExceptions()
    data class SavePictureException(override val message: String) : CaptureUserPhotoExceptions()
    data class PictureNotFoundException(override val message: String) : CaptureUserPhotoExceptions()

}


fun CaptureUserPhotoExceptions.toError(): CaptureUserPhotoErrors = when (this) {
